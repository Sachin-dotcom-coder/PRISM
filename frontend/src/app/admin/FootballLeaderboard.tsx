...
export default function FootballLeaderboard() {
  ...
  if (error) return <div className="text-red-400 p-4 text-center text-sm">Failed to load standings.</div>;
  if (!teams) return <div className="text-zinc-500 animate-pulse p-4 text-center text-sm">Loading standings...</div>;
