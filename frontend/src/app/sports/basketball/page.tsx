    ...
    <div className="min-h-screen bg-[#000000] text-[#FFFFFF] font-sans flex justify-center selection:bg-[#FFBF00] selection:text-black">
      <div className="w-full max-w-7xl p-4 sm:p-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-[#1A1A1A] pb-6 gap-4">
          <h1 className="text-[#FFBF00] font-black text-6xl md:text-7xl tracking-tighter uppercase">Basketball</h1>
          <div className="text-left md:text-right text-sm md:text-base text-gray-400 space-y-1 font-medium tracking-wide">
            <p><span className="text-gray-200">Event:</span> PRISM 2026 <span className="mx-2 text-[#333]">|</span> <span className="text-gray-200">Venue:</span> SVNIT Indoor Court</p>
          </div>
        </header>
...
function Results() {
  const matches = [
    { id: 1, stage: "Group A", team1: "ECE", team2: "CSE", score1: 68, score2: 54, winner: "ECE", quarters: ["18-12", "16-14", "20-16", "14-12"] },
    { id: 2, stage: "Group A", team1: "MECH", team2: "AI+MBA", score1: 45, score2: 60, winner: "AI+MBA", quarters: ["10-18", "12-14", "12-16", "11-12"] },
    { id: 3, stage: "Group B", team1: "CHEM", team2: "EE", score1: 72, score2: 65, winner: "CHEM", quarters: ["20-15", "18-20", "18-14", "16-16"] },
    { id: 4, stage: "Group B", team1: "CIVIL", team2: "SCI", score1: 50, score2: 48, winner: "CIVIL", quarters: ["14-12", "12-14", "12-10", "12-12"] },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      {matches.map((match) => (
        <div key={match.id} className="border border-[#1A1A1A] bg-[#000000] rounded-2xl p-5 md:p-6 relative overflow-hidden hover:border-[#FFBF00]/20 transition-colors">
          <div className="flex justify-between items-center mb-4 border-b border-[#1A1A1A] pb-3">
            ...
            <span className="text-gray-500 text-xs font-bold tracking-widest uppercase">FT</span>
          </div>
          ...
          {/* Quarter breakdown */}
          <div className="mt-4 pt-4 border-t border-[#1A1A1A] flex flex-wrap gap-2 justify-center">
            {match.quarters.map((q, i) => (
              <div key={i} className="flex flex-col items-center bg-[#0A0A0A] border border-[#1A1A1A] rounded-lg px-3 py-2 min-w-[56px]">
                <span className="text-gray-500 text-[10px] font-bold uppercase tracking-widest mb-1">Q{i + 1}</span>
  ...
  const groups = [
    {
      name: "Group A",
      teams: [
        { name: "ECE", p: 3, w: 3, l: 0, pts: 6, pf: 195, pa: 162 },
        { name: "AI+MBA", p: 3, w: 2, l: 1, pts: 4, pf: 178, pa: 160 },
        { name: "CSE", p: 3, w: 1, l: 2, pts: 2, pf: 155, pa: 172 },
        { name: "MECH", p: 3, w: 0, l: 3, pts: 0, pf: 138, pa: 172 },
      ],
    },
    {
      name: "Group B",
      teams: [
        { name: "CHEM", p: 3, w: 3, l: 0, pts: 6, pf: 210, pa: 185 },
        { name: "CIVIL", p: 3, w: 2, l: 1, pts: 4, pf: 185, pa: 176 },
        { name: "EE", p: 3, w: 1, l: 2, pts: 2, pf: 174, pa: 188 },
        { name: "SCI", p: 3, w: 0, l: 3, pts: 0, pf: 160, pa: 180 },
      ],
    },
  ];
...
function Fixtures() {
  const fixtures = [
    ...
    { group: "A", match: "MECH vs AI+MBA", date: "Oct 13, 10:00 AM", id: 2 },
    { group: "A", match: "ECE vs MECH", date: "Oct 14, 10:00 AM", id: 3 },
    { group: "A", match: "CSE vs AI+MBA", date: "Oct 15, 10:00 AM", id: 4 },
    { group: "A", match: "ECE vs AI+MBA", date: "Oct 16, 10:00 AM", id: 5 },
    { group: "A", match: "CSE vs MECH", date: "Oct 17, 10:00 AM", id: 6 },
    { group: "B", match: "CHEM vs EE", date: "Oct 12, 02:00 PM", id: 7 },
    { group: "B", match: "CIVIL vs SCI", date: "Oct 13, 02:00 PM", id: 8 },
    { group: "B", match: "CHEM vs CIVIL", date: "Oct 14, 02:00 PM", id: 9 },
    { group: "B", match: "EE vs SCI", date: "Oct 15, 02:00 PM", id: 10 },
    { group: "B", match: "CHEM vs SCI", date: "Oct 16, 02:00 PM", id: 11 },
    { group: "B", match: "EE vs CIVIL", date: "Oct 17, 02:00 PM", id: 12 },
  ];
