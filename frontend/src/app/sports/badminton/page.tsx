    ...
    <div className="min-h-screen bg-[#000000] text-[#FFFFFF] font-sans flex justify-center selection:bg-[#FFBF00] selection:text-black">
      <div className="w-full max-w-7xl p-4 sm:p-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-[#1A1A1A] pb-6 gap-4">
          <h1 className="text-[#FFBF00] font-black text-6xl md:text-7xl tracking-tighter uppercase">Badminton</h1>
          <div className="text-left md:text-right text-sm md:text-base text-gray-400 space-y-1 font-medium tracking-wide">
            <p><span className="text-gray-200">Event:</span> PRISM 2026 <span className="mx-2 text-[#333]">|</span> <span className="text-gray-200">Venue:</span> SVNIT Badminton Court</p>
          </div>
        </header>

        <div className="flex flex-col gap-6 mb-10">
          {/* Gender + Match Type toggles */}
...
function Results({ matchType }: { matchType: "singles" | "doubles" }) {
  const matches = [
    {
      id: 1, stage: "Group", matchType: "singles", team1: "ECE", team2: "CSE",
      score1: 2, score2: 1, winner: "ECE",
      games: [{ g: 1, s1: 21, s2: 18 }, { g: 2, s1: 15, s2: 21 }, { g: 3, s1: 21, s2: 17 }],
    },
    {
      id: 2, stage: "Group", matchType: "doubles", team1: "MECH", team2: "AI+MBA",
      score1: 2, score2: 0, winner: "MECH",
      games: [{ g: 1, s1: 21, s2: 14 }, { g: 2, s1: 21, s2: 19 }],
    },
    {
      id: 3, stage: "Semifinal", matchType: "singles", team1: "CHEM", team2: "EE",
      score1: 1, score2: 2, winner: "EE",
      games: [{ g: 1, s1: 21, s2: 17 }, { g: 2, s1: 18, s2: 21 }, { g: 3, s1: 19, s2: 21 }],
    },
    {
      id: 4, stage: "Final", matchType: "doubles", team1: "CIVIL", team2: "SCI",
      score1: 2, score2: 1, winner: "CIVIL",
      games: [{ g: 1, s1: 21, s2: 15 }, { g: 2, s1: 17, s2: 21 }, { g: 3, s1: 21, s2: 18 }],
    },
  ];
...
function Leaderboard() {
  const groups = [
    ...
    },
    {
      name: "Group B",
      teams: [
        { name: "CHEM", p: 4, w: 3, l: 1, pts: 6 },
        { name: "EE", p: 4, w: 3, l: 1, pts: 6 },
...
function Fixtures() {
  const fixtures = [
    ...
    { group: "A", match: "MECH vs AI+MBA", type: "Doubles", date: "Oct 12, 10:00 AM", id: 2 },
    { group: "A", match: "ECE vs MECH", type: "Singles", date: "Oct 13, 09:00 AM", id: 3 },
    { group: "A", match: "CSE vs AI+MBA", type: "Doubles", date: "Oct 13, 10:00 AM", id: 4 },
    { group: "A", match: "ECE vs AI+MBA", type: "Singles", date: "Oct 14, 09:00 AM", id: 5 },
    { group: "A", match: "CSE vs MECH", type: "Doubles", date: "Oct 14, 10:00 AM", id: 6 },
