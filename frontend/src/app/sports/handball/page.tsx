...
export default function HandballDashboard() {
    ...
    <div className="min-h-screen bg-[#000000] text-[#FFFFFF] font-sans flex justify-center selection:bg-[#FFBF00] selection:text-black">
      <div className="w-full max-w-7xl p-4 sm:p-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-[#1A1A1A] pb-6 gap-4">
          <h1 className="text-[#FFBF00] font-black text-6xl md:text-7xl tracking-tighter uppercase">Handball</h1>
          <div className="text-left md:text-right text-sm md:text-base text-gray-400 space-y-1 font-medium tracking-wide">
            <p><span className="text-gray-200">Event:</span> PRISM 2026 <span className="mx-2 text-[#333]">|</span> <span className="text-gray-200">Venue:</span> SVNIT Main Ground</p>
          </div>
        </header>
...
function Results() {
  const matches = [
    { id: 1, stage: "League", team1: "ECE", team2: "CSE", score1: 24, score2: 19, winner: "ECE" },
    { id: 2, stage: "League", team1: "MECH", team2: "AI+MBA", score1: 16, score2: 21, winner: "AI+MBA" },
    { id: 3, stage: "League", team1: "CHEM", team2: "EE", score1: 28, score2: 22, winner: "CHEM" },
    { id: 4, stage: "Semi Final", team1: "ECE", team2: "CHEM", score1: 20, score2: 22, winner: "CHEM" },
    { id: 5, stage: "Final", team1: "CHEM", team2: "AI+MBA", score1: 30, score2: 25, winner: "CHEM" },
  ];
      ...
      {matches.map((match) => (
        <div key={match.id} className="border border-[#1A1A1A] bg-[#000000] rounded-2xl p-5 md:p-6 hover:border-[#FFBF00]/20 transition-colors">
          <div className="flex justify-between items-center mb-5 border-b border-[#1A1A1A] pb-3">
            ...
            <span className="text-gray-500 text-xs font-bold tracking-widest uppercase">Full Time</span>
          </div>
  ...
  const groups = [
    {
      name: "Group A",
      teams: [
        { name: "ECE", p: 3, w: 3, l: 0, gf: 72, ga: 55, pts: 6 },
        { name: "AI+MBA", p: 3, w: 2, l: 1, gf: 65, ga: 58, pts: 4 },
        { name: "CSE", p: 3, w: 1, l: 2, gf: 55, ga: 65, pts: 2 },
        { name: "MECH", p: 3, w: 0, l: 3, gf: 48, ga: 62, pts: 0 },
      ],
    },
    {
      name: "Group B",
      teams: [
        { name: "CHEM", p: 3, w: 3, l: 0, gf: 88, ga: 62, pts: 6 },
        { name: "EE", p: 3, w: 2, l: 1, gf: 70, ga: 68, pts: 4 },
        { name: "CIVIL", p: 3, w: 1, l: 2, gf: 60, ga: 72, pts: 2 },
        { name: "SCI", p: 3, w: 0, l: 3, gf: 52, ga: 68, pts: 0 },
      ],
    },
  ];
              ...
              <tbody className="divide-y divide-[#1A1A1A]">
                {group.teams.map((team, index) => (
                  <tr key={index} className="hover:bg-[#0A0A0A] transition-colors">
                    ...
                    <td className="py-5 px-3 text-center text-gray-400 hidden sm:table-cell">{team.gf}</td>
                    <td className="py-5 px-3 text-center text-gray-400 hidden sm:table-cell">{team.ga}</td>
...
function Fixtures() {
  const fixtures = [
    { group: "A", match: "ECE vs CSE", date: "Oct 12, 08:00 AM", id: 1 },
    { group: "A", match: "MECH vs AI+MBA", date: "Oct 13, 08:00 AM", id: 2 },
    { group: "A", match: "ECE vs MECH", date: "Oct 14, 08:00 AM", id: 3 },
    { group: "A", match: "CSE vs AI+MBA", date: "Oct 15, 08:00 AM", id: 4 },
    { group: "A", match: "ECE vs AI+MBA", date: "Oct 16, 08:00 AM", id: 5 },
    { group: "A", match: "CSE vs MECH", date: "Oct 17, 08:00 AM", id: 6 },
    { group: "B", match: "CHEM vs EE", date: "Oct 12, 12:00 PM", id: 7 },
    { group: "B", match: "CIVIL vs SCI", date: "Oct 13, 12:00 PM", id: 8 },
    { group: "B", match: "CHEM vs CIVIL", date: "Oct 14, 12:00 PM", id: 9 },
    { group: "B", match: "EE vs SCI", date: "Oct 15, 12:00 PM", id: 10 },
    { group: "B", match: "CHEM vs SCI", date: "Oct 16, 12:00 PM", id: 11 },
    { group: "B", match: "EE vs CIVIL", date: "Oct 17, 12:00 PM", id: 12 },
  ];
